...
src_model_path=ai4bharat/indic-bert
tgt_model_path=ai4bharat/indic-bert
...
#cp /home/hsaadi/helper_folder/embeddings/${prefix}.${lang_pair}.${tgt_lang} \
#/home/hsaadi/helper_folder/embeddings/${prefix}.${previous_lang_pair}.${tgt_lang}