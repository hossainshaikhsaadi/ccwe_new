...
xnli_path=${base_directory}/saved_models/${method}.${prefix}.${xnli_lang}.pt
finetuned_lm_path=${base_directory}/saved_models/${method}.${prefix}.${xnli_lang}.lm.pt
mapping_method=rcsls-mat #vecmap.npy
...
log_file=${base_directory}/log_files/${prefix}.${method}.${src_lang}.txt
